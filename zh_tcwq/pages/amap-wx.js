  ...
  AMapWX.prototype.getRegeo = function (a) {
    function c(c) {
      ...
      wx.request({
        ...
        success: function (b) {
          var d, e, f, g, h, i, j, k, l; b.data.status && "1" == b.data.status ? (
            d = b.data.regeocode,
