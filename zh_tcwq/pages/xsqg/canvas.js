...
Page({
  ...
  createNewImg: function () {
    ...
    var name = that.data.QgGoodInfo.store_name, money = '￥' + that.data.QgGoodInfo.money, price = '￥' + that.data.QgGoodInfo.price, title = that.data.QgGoodInfo.money + '元抢' + that.data.QgGoodInfo.name, endtime = "抢购结束日期:" +that.data.QgGoodInfo.end_time;
    //绘制名字
    ...
    context.setFontSize(16);
    context.setTextAlign('center');
    context.fillText("长按二维码识别小程序参与抢购", 187.5, 529);
    //
