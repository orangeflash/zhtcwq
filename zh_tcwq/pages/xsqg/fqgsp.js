...
Page({
  ...
  formSubmit: function (e) {
    ...
    console.log(mdid, uid, splx, px, spmc, sj, yj, spsl, spjj, spxq, starttime, endtime, jztime,logo,lbimages,jsimages)
    var warn = "";
    var flag = true;
    if (spmc == "") {
      warn = "请填商品名称！";
      ...
      function e() {
        ...
        app.util.request({
          ...
          'cachetime': '0',
          data: { store_id: mdid, num:px, name: spmc, logo: n[0].uploaded_pic_list.toString(), price: yj, money: sj, number: spsl, start_time: starttime, end_time: endtime, consumption_time: jztime, details: spxq, type_id: splx.id, img: n[1].uploaded_pic_list.toString(), details_img: n[2].uploaded_pic_list.toString(), content:spjj },
