...
Page({
  ...
  formSubmit: function (e) {
    ...
    console.log(mdid, uid, splx, px, spmc, sj, yj, ktrs, ddgjg, spsl, spxl, yctsl, spjj, spxq, starttime, endtime, jztime, typeof (this.data.logo), logo, lbimg, lbimages, jsimages, jsimg)
    var warn = "";
    var flag = true;
    if (spmc == "") {
      warn = "请填商品名称！";
      ...
      function e() {
        ...
        app.util.request({
          ...
          'cachetime': '0',
          data: { store_id: mdid, num: px, name: spmc, logo: spzt, y_price: yj, pt_price: sj, dd_price: ddgjg, inventory: spsl, ycd_num: yctsl, ysc_num: spxl, people: ktrs, is_shelves: that.data.QgGoodInfo.is_shelves, start_time: starttime, end_time: endtime, xf_time: jztime, details: spxq, type_id: splx.id, introduction: spjj, img: img.toString(), details_img: details_img.toString(), id: spid },
      ...
      success: function (res) {
        ...
        app.util.request({
          ...
          success: function (res) {
            ...
            res.data.xf_time = util.ormatDate(res.data.xf_time).substring(0, 10)
            let ginfo=res.data;
            ...
            that.setData({
              ...
              yj: ginfo.y_price,
              ktrs: ginfo.people,
              ddgjg: ginfo.dd_price,
              spsl: ginfo.inventory,
              yctsl: ginfo.ycd_num,
              spxl: ginfo.ysc_num,
              spjj: ginfo.introduction,
              timestart: ginfo.start_time,
              timeend: ginfo.end_time,
              jztime: ginfo.xf_time,
              spxq: ginfo.details,
            })
          }
        });
